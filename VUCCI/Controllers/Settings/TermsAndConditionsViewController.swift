...
class TermsAndConditionsViewController: UIViewController {
    ...
    private let privacyPolicyTitle: UILabel = {
        ...
        label.text = "Tap below to view VUCCI's privacy policy"
        return label
    }()
    
    private let viewPrivacyPolicyButton: UIButton = {
        let button = UIButton()
    ...
    private let effectiveDateText: UILabel = {
        ...
        label.text = "Effective date: June 26, 2022"
        return label
    }()
    ...
    private let copyrightText: UILabel = {
        ...
        label.font = .systemFont(ofSize: 16, weight: .light)
        label.numberOfLines = 0
        label.text = "We respect the intellectual property rights of others. If you believe that any material available on or through the app infringes upon any copyright you own or control, please immediately notify us at vucciapp@gmail.com. The user will be contacted and addressed."
        return label
    }()
    ...
    private let contactText: UILabel = {
        ...
        label.numberOfLines = 2
        label.font = .systemFont(ofSize: 20, weight: .medium)
        label.text = "contact us at vucciapp@gmail.com"
        return label
    }()
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(viewPrivacyPolicyButton)
        view.addSubview(privacyPolicyTitle)
        viewPrivacyPolicyButton.addTarget(self, action: #selector(didTapPrivacyPolicy), for: .touchUpInside)
        setUpScrollView()
    }
    
    override func viewDidLayoutSubviews() {
        super.viewDidLayoutSubviews()
        scrollView.frame = CGRect(x: 20, y: view.safeAreaInsets.top + 10, width: view.width-40, height: ((view.height/4)*3) - 90)
        privacyPolicyTitle.frame = CGRect(x: 20, y: scrollView.bottom + 7, width: view.width - 40, height: 20)
        viewPrivacyPolicyButton.frame = CGRect(x: 30, y: privacyPolicyTitle.bottom + 7, width: view.width - 60, height: 20)
        
    }

    private func setUpScrollView() {
        scrollView.contentSize = CGSize(width: view.width - 40, height: (15550))
        scrollView.addSubview(vucciText)
        vucciText.frame = CGRect(x: 25, y: scrollView.top + 20, width: view.width - 80, height: 20)
        scrollView.addSubview(effectiveDateText)
        effectiveDateText.frame = CGRect(x: 25, y: vucciText.bottom + 15, width: view.width - 80, height: 20)
        ...
        appManagementTitle.frame = CGRect(x: 25, y: mobileApplicationLicenseText.bottom + 10, width: view.width - 80, height: 20)
